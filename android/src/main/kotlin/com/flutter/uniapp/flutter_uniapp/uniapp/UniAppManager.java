...
//        }
    ...
    public static void openRemoteMini(Context context, String wgtUrl,String password, String path) {
        //TODO 需要申请 android.permission.WRITE_EXTERNAL_STORAGE 权限
        //
        final String wgtName;
        wgtName = wgtUrl.substring(wgtUrl.lastIndexOf('/')+1);
        String appId = wgtName.substring(0,wgtName.lastIndexOf("."));
        Handler uiHandler = new Handler();
        String finalPassword = password;

        String downFilePath = context.getExternalCacheDir().getPath()+"/miniApp";
        ...
        DownloadUtil.get().download(context, wgtUrl, downFilePath, wgtName, new DownloadUtil.OnDownloadListener() {
            ...
            public void onDownloadSuccess(File file) {
                ...
                uniMPReleaseConfiguration.password = finalPassword;
                uiHandler.post(() -> DCUniMPSDK.getInstance().releaseWgtToRunPath(appId, uniMPReleaseConfiguration, new IUniMPReleaseCallBack() {
                    @Override
